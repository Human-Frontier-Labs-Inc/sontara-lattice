...
type ForensicSnapshot struct {
	...
	KernelMods   string    `json:"kernel_modules,omitempty"`
	PreloadFile  string    `json:"preload_file,omitempty"`
	PAMModules   string    `json:"pam_modules,omitempty"`
	UserCrontab  string    `json:"user_crontab,omitempty"`
	SystemCron   string    `json:"system_cron,omitempty"`
