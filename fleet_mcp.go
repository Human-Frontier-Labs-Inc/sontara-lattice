	...
	},
	{
		...
		"inputSchema": map[string]any{
			...
			"properties": map[string]any{
				"name": map[string]any{
					"type":        "string",
					"description": "The display name for this session (e.g. 'auth-debugger', 'frontend-dev')",
				},
			},
...
5. If the user asks you to name yourself or call yourself something, use set_name -- do NOT write it to memory.
