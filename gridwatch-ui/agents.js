...
const DAEMON_DEFS = {
  'fleet-scout':  { tag: 'FS', color: '#50f872', schedule: 'interval:10m' },
  'llm-watchdog': { tag: 'LW', color: '#D97757', schedule: 'interval:10m' },
  'sync-janitor': { tag: 'SJ', color: '#a4ffec', schedule: 'interval:15m' },
  'librarian':    { tag: 'LB', color: '#c4a7e7', schedule: 'interval:3h' },
};
